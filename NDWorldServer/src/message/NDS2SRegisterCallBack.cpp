...
//	{
//		NDTOTAL_LOG_ERROR( " [NDS2SRegisterCallBack::c2gdbRegisterResDispose] NDC2GDB_Register_Res deserialize failed! " )
//		return NDFalse;
//	}
//		
...
//	{
//		NDTOTAL_LOG_ERROR( " [NDS2SRegisterCallBack::c2gdbRegisterResDispose] pGameDBServerInfo is NULL! " )
//		return NDFalse;
//	}
//
...
NDBool NDS2SRegisterCallBack::ls2wsRegisterResDispose( NDIStream& rIStream, NDProtocolHeader& header )
{
	...
	if ( NDFalse == registerRes.Deserialize(rIStream) ) 
	{
		NDTOTAL_LOG_ERROR( " [NDS2SRegisterCallBack::ls2wsRegisterResDispose] NDLS2WS_Register_Res deserialize failed!" )
		return NDFalse;
	}
	...
	{
		NDTOTAL_LOG_ERROR( " [NDS2SRegisterCallBack::ls2wsRegisterResDispose] pLoginServerInfo is NULL!" )
		return NDFalse;
	}

	if ( eND_SRS_OK == registerRes.m_uiErrCode )
	{
		ostringstream& oStr = sNDWorldServer.getostringstream();
		oStr		<< " register "
					<< pLoginServerInfo->getServerName()	<< " ["
...
//	{
//		NDTOTAL_LOG_ERROR( " [NDS2SRegisterCallBack::g2cRegisterReqDispose] NDG2C_Register_Req deserialize failed! " )
//		return NDFalse;
//	}
//
...
//	{
//		NDTOTAL_LOG_ERROR( " [NDS2SRegisterCallBack::g2cRegisterReqDispose] pGateServerInfo is NULL! " )
//		return NDFalse;
//	}
//
...
//	{
//		NDTOTAL_LOG_ERROR( " [NDS2SRegisterCallBack::g2cRegisterReqDispose] pGateServerMgr is NULL! " )
//		return NDFalse;
//	}
//
...
//	{
//		NDTOTAL_LOG_ERROR( " [NDS2SRegisterCallBack::m2cRegisterReqDispose] NDM2C_Register_Req deserialize failed! " )
//		return NDFalse;
//	}
//
...
//	{
//		NDTOTAL_LOG_ERROR( " [NDS2SRegisterCallBack::m2cRegisterReqDispose] new NDMapServerInfo failed! " )
//		return NDFalse;
//	}
//
