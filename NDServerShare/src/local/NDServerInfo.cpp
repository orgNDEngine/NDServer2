...
{
	NDUint32 nStrLen = 0;
	if ( NDFalse == NDShareBaseGlobal::nd_isValidStrParam( szName, nStrLen ) )
	{
		return NDFalse;
	}
...
{
	NDUint32 nStrLen = 0;
	if ( NDFalse == NDShareBaseGlobal::nd_isValidStrParam( szDumpPath, nStrLen ) )
	{
		return NDFalse;
	}
...
{
	NDUint32 nStrLen = 0;
	if ( NDFalse == NDShareBaseGlobal::nd_isValidStrParam( szLogPath, nStrLen ) )
	{
		return NDFalse;
	}
