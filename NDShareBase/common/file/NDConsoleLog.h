...
#define NDLOG_INFO		(std::cerr<<NDConsoleColor(TNORMAL))
#define NDLOG_WARNGING	(std::cerr<<NDConsoleColor(TGREEN|TRED))
#define NDLOG_ERROR		(std::cerr<<NDConsoleColor(TRED))
#define NDLOG_END		NDConsoleColor(TNORMAL)<<std::endl
