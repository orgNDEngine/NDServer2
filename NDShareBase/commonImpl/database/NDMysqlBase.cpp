...
void* NDMysqlBase::selectSql( NDUint32 nProtocolID, void* pProtocolReq, NDBool bChinese )
{
	if ( NULL == m_pMysqlBaseOp )
	{
		NDLOG_ERROR << " NDMysqlBase::selectSql m_pMysqlBaseOp is NULL! " << NDLOG_END;
		return NULL;
	}
	...
	{
		NDLOG_ERROR << " NDMysqlBase::selectSql pszQuery is NULL! " << NDLOG_END;
	}
	else
	{
		...
		if ( NULL == pMysqlRes )
		{
			NDLOG_INFO << " NDMysqlBase::selectSql MYSQL_RES is NULL! " << NDLOG_END;
		}
		else
		{
...
NDUint32 NDMysqlBase::updateSql( NDUint32 nProtocolID, void* pProtocolReq, NDBool bChinese )
{
	if ( NULL == m_pMysqlBaseOp )
	{
		NDLOG_ERROR << " NDMysqlBase::updateSql m_pMysqlBaseOp is NULL! " << NDLOG_END;
		return 0;
	}
	...
	if ( (NULL == pszQuery) || ('\0' == pszQuery[0]) )
	{
		NDLOG_ERROR << " NDMysqlBase::updateSql pszQuery is NULL! " << NDLOG_END;
	}
	else
	{
...
NDUint32 NDMysqlBase::insertSql( NDUint32 nProtocolID, void* pProtocolReq, NDBool bChinese )
{
	if ( NULL == m_pMysqlBaseOp )
	{
		NDLOG_ERROR << " NDMysqlBase::insertSql m_pMysqlBaseOp is NULL! " << NDLOG_END;
		return 0;
	}
	...
	if ( (NULL == pszQuery) || ('\0' == pszQuery[0]) )
	{
		NDLOG_ERROR << " NDMysqlBase::insertSql pszQuery is NULL! " << NDLOG_END;
	}
	else
	{
...
NDUint32 NDMysqlBase::deleteSql( NDUint32 nProtocolID, void* pProtocolReq, NDBool bChinese )
{
	if ( NULL == m_pMysqlBaseOp )
	{
		NDLOG_ERROR << " NDMysqlBase::deleteSql m_pMysqlBaseOp is NULL! " << NDLOG_END;
		return 0;
	}
	...
	if ( (NULL == pszQuery) || ('\0' == pszQuery[0]) )
	{
		NDLOG_ERROR << " NDMysqlBase::deleteSql pszQuery is NULL! " << NDLOG_END;
	}
	else
	{
