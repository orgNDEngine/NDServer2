...
NDBool NDByteBufferImpl::ReadInt16( NDInt16 &refInt16 )
{
	...
	if ( bRet == NDTrue )
	{
		NDShareBaseGlobal::nd_swap16( &refInt16 );
	}
#else
#endif
...
NDBool NDByteBufferImpl::ReadInt32( NDInt32 &refInt32 )
{
	...
	if ( bRet == NDTrue )
	{
		NDShareBaseGlobal::nd_swap32( &refInt32 );
	}
#else
#endif
...
NDBool NDByteBufferImpl::ReadInt64( NDInt64 &refInt64 )
{
	...
	if ( bRet == NDTrue )
	{
		NDShareBaseGlobal::nd_swap64( &refInt64 );
	}
#else
#endif
...
NDBool NDByteBufferImpl::ReadUint16( NDUint16 &refUint16 )
{
	...
	if ( bRet == NDTrue )
	{
		NDShareBaseGlobal::nd_swap16( &refUint16 );
	}
#else
#endif
...
NDBool NDByteBufferImpl::ReadUint32( NDUint32 &refUint32 )
{
	...
	if ( bRet == NDTrue )
	{
		NDShareBaseGlobal::nd_swap32( &refUint32 );
	}
#else
#endif
...
NDBool NDByteBufferImpl::ReadUint64( NDUint64 &refUint64 )
{
	...
	if ( bRet == NDTrue )
	{
		NDShareBaseGlobal::nd_swap64( &refUint64 );
	}
#else
#endif
...
NDBool NDByteBufferImpl::ReadFloat32( NDFloat32 &refFloat32 )
{
	...
	if ( bRet == NDTrue )
	{
		NDShareBaseGlobal::nd_swapfloat( &refFloat32 );
	}
#else
#endif
...
NDBool NDByteBufferImpl::ReadFloat64( NDFloat64 &refFloat64 )
{
	...
	if ( bRet == NDTrue )
	{
		NDShareBaseGlobal::nd_swapdouble( &refFloat64 );
	}
#else
#endif
...
#ifdef USING_BIG_ENDIAN
	NDShareBaseGlobal::nd_swap16( &nInt16 );
#else
#endif
...
#ifdef USING_BIG_ENDIAN
	NDShareBaseGlobal::nd_swap32( &nInt32 );
#else
#endif
...
#ifdef USING_BIG_ENDIAN
	NDShareBaseGlobal::nd_swap64( &nInt64 );
#else
#endif
...
#ifdef USING_BIG_ENDIAN
	NDShareBaseGlobal::nd_swap16( &nUint16 );
#else
#endif
...
#ifdef USING_BIG_ENDIAN
	NDShareBaseGlobal::nd_swap32( &nUint32 );
#else
#endif
...
#ifdef USING_BIG_ENDIAN
	NDShareBaseGlobal::nd_swap64( &nUint64 );
#else
#endif
...
#ifdef USING_BIG_ENDIAN
	NDShareBaseGlobal::nd_swapfloat( &fFloat32 );
#else
#endif
...
#ifdef USING_BIG_ENDIAN
	NDShareBaseGlobal::nd_swapdouble( &fFloat64 );
#else
#endif
