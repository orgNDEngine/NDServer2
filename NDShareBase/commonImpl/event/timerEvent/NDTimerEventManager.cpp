...
{
	m_nStartMSTime = NDShareBaseGlobal::nd_getCurMSTimeOfUTC();
...
{
	NDTime	nNowMSTime	= NDShareBaseGlobal::nd_getCurMSTimeOfUTC();
...
NDUint32 NDTimerManager::cascade( NDUint32 nWheelIndex )
{
	...
	int casnum = 0;
	NDTime now = NDShareBaseGlobal::nd_getCurMSTimeOfUTC();
